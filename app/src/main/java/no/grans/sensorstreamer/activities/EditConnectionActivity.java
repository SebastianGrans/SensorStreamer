package no.grans.sensorstreamer.activities;
...
import no.grans.sensorstreamer.SharedStorageManager;
import no.grans.sensorstreamer.fragments.SpecialisedConnectionInterface;
import no.grans.sensorstreamer.fragments.TcpClientConnectionFragment;
import no.grans.sensorstreamer.fragments.TcpServerConnectionFragment;
import no.grans.sensorstreamer.models.Connection;
import no.grans.sensorstreamer.util.TaggedString;
...
{
    public final static String EXTRA_CONNECTION = "no.grans.no.grans.CONNECTION_IDX";
