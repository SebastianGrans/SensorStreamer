...
public class EditPacketActivity extends AppCompatActivity {
    public final static String EXTRA_PACKET ="no.grans.no.grans.PACKET_IDX";
    ...
    private void setupCheckboxes() {
        ...
        c = (CheckBox) findViewById(R.id.pose_vector);
        if (sManager.getDefaultSensor(Sensor.TYPE_POSE_6DOF) == null) {
            // It seems like this message type is added for future use.
            c.setEnabled(false);
        }
        c.setChecked(mPacket.poseVector);
    ...
    void onSave() {
        ...
        c = (CheckBox) findViewById(R.id.pose_vector);
        mPacket.poseVector = c.isChecked();
