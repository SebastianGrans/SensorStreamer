    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent.getAction().equals(START)) {
            ...
            switch (connection.type) {
                case TcpClient:
                    Log.d("debug", "Create TCP Client instance");
            ...
            // FIXME: Clean this up
            // After updating to a newer SDK I got an error on `startForeground`
            // I found this: https://stackoverflow.com/questions/47531742/startforeground-fail-after-upgrade-to-android-8-1

            String NOTIFICATION_CHANNEL_ID = "no.grans.sensorstreamer";
            ...
            Notification notification = notificationBuilder.setOngoing(true)
                    ...
                    .addAction(R.drawable.ic_stat_name, getString(R.string.stop), pStop)
                    .setContentText(mSender.getDescription(this)).build();
